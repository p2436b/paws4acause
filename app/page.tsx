...
export default function Home() {
  return (
    <main className='flex min-h-screen flex-col gap-4'>
      <div className='h-[500px] relative drop-shadow-lg'>
        <Image src='/images/pic_03.jpg' fill alt='' className='object-cover' />
      </div>
      <div className='px-40'>
        <h1 className='text-purple-800 text-4xl font-semibold'>Hi!</h1>
        <p className='text-justify leading-loose'>
          ...
          lives. With your support, we can continue to make a paw-sitive impact on the world, one wagging tail at a time. Join us
          in our mission to make the world a better place for all creatures, great and small.
        </p>
      </div>
    </main>
  );
