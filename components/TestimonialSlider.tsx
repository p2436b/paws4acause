...
const testimonials = [
	{
		...
		jobTitle: 'Volunteer',
		comment:
			"Volunteering at Paws for a Cause has been an incredibly rewarding experience. Being able to contribute to the well-being of these animals and seeing the joy on their faces when they find their forever homes is priceless. The team here is so passionate and dedicated, and I'm proud to be a part of such a wonderful organization.",
	...
	},
	{
		...
		jobTitle: 'Volunteer',
		comment:
			"I've been volunteering at Paws for a Cause for over a year now, and it has truly been life-changing. Working with the animals has taught me so much about compassion, patience, and unconditional love. Every day, I leave feeling fulfilled knowing that I've made a difference in their lives, even if it's just a small one.",
	...
	},
	{
		...
		jobTitle: 'Volunteer',
		comment:
			"Volunteering at Paws for a Cause has been a dream come true for me. As an animal lover, being able to spend time with these furry friends and help them on their journey to finding forever homes brings me so much joy. The staff and fellow volunteers are like family, and I'm grateful for the opportunity to be a part of such a caring community.",
